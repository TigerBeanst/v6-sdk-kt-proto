...
// Source: v6.services.pub.DavConfig in public_webdav.proto
...
public class DavConfig(
...
) : Message<DavConfig, Nothing>(ADAPTER, unknownFields) {
  @Deprecated(
  ...
  override fun equals(other: Any?): Boolean {
    ...
    if (other !is DavConfig) return false
  ...
  override fun toString(): String {
    ...
    return result.joinToString(prefix = "DavConfig{", separator = ", ", postfix = "}")
  }
  ...
  ): DavConfig = DavConfig(user_identity, enable_flag, root, write_flag, lock_flag, chunked_flag,
      path_style, status, prefix, code, message, username, password, update_ts, unknownFields)

  public companion object {
    @JvmField
    public val ADAPTER: ProtoAdapter<DavConfig> = object : ProtoAdapter<DavConfig>(
      FieldEncoding.LENGTH_DELIMITED, 
      DavConfig::class, 
      "type.googleapis.com/v6.services.pub.DavConfig", 
      PROTO_3, 
      null, 
      "public_webdav.proto"
    ) {
      override fun encodedSize(`value`: DavConfig): Int {
      ...
      override fun encode(writer: ProtoWriter, `value`: DavConfig) {
      ...
      override fun encode(writer: ReverseProtoWriter, `value`: DavConfig) {
        writer.writeBytes(value.unknownFields)
        if (value.update_ts != 0L) ProtoAdapter.INT64.encodeWithTag(writer, 14, value.update_ts)
        if (value.password != "") ProtoAdapter.STRING.encodeWithTag(writer, 13, value.password)
        if (value.username != "") ProtoAdapter.STRING.encodeWithTag(writer, 12, value.username)
      ...
      override fun decode(reader: ProtoReader): DavConfig {
      ...
      override fun redact(`value`: DavConfig): DavConfig = value.copy(
